...
NEW_CHECKPOINT_DISC_AM = "../drive/MyDrive/Checkpoints/AppleToOrange20/disc_a.pth.tar"
NEW_CHECKPOINT_DISC_BM = "../drive/MyDrive/Checkpoints/AppleToOrange20/disc_b.pth.tar"
